...
if ((M >= 1) && (N >= 1)) {
  lbp=0;
  ubp=floord(M-1,32);
#pragma omp parallel for private(lbv,ubv,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,t14,t15)
      ...
      for (t4=0;t4<=floord(N-1,32);t4++) {
        for (t5=0;t5<=floord(N-1,32);t5++) {
          for (t8=0;t8<=floord(N-1,32);t8++) {
            for (t9=32*t2;t9<=min(M-1,32*t2+31);t9++) {
              for (t10=32*t3;t10<=min(N-1,32*t3+31);t10++) {
                for (t11=32*t4;t11<=min(N-1,32*t4+31);t11++) {
                  for (t12=32*t5;t12<=min(N-1,32*t5+31);t12++) {
                    for (t15=32*t8;t15<=min(N-1,32*t8+31);t15++) {
                      rt[t9][t10][t11][t12] += L[t10][t15] * w[t11] * w[t12] * ut[t9][t15][t11][t12];;
                    }
                  }
                }
              }
            ...
            for (t9=32*t2;t9<=min(M-1,32*t2+31);t9++) {
              for (t10=32*t3;t10<=min(N-1,32*t3+31);t10++) {
                for (t11=32*t4;t11<=min(N-1,32*t4+31);t11++) {
                  for (t12=32*t5;t12<=min(N-1,32*t5+31);t12++) {
                    for (t15=32*t8;t15<=min(N-1,32*t8+31);t15++) {
                      rt[t9][t10][t11][t12] += w[t10] * L[t11][t15] * w[t12] * ut[t9][t10][t15][t12];;
                    }
                  }
                }
              }
            ...
            for (t9=32*t2;t9<=min(M-1,32*t2+31);t9++) {
              for (t10=32*t3;t10<=min(N-1,32*t3+31);t10++) {
                for (t11=32*t4;t11<=min(N-1,32*t4+31);t11++) {
                  for (t12=32*t5;t12<=min(N-1,32*t5+31);t12++) {
                    for (t15=32*t8;t15<=min(N-1,32*t8+31);t15++) {
                      rt[t9][t10][t11][t12] += w[t10] * w[t11] * L[t12][t15] * ut[t9][t10][t11][t15];;
                    }
                  }
                }
              }
