 ...
 for(j2 = 0; j2 < 8; j2 += 1) {
  for(j3 = 0; j3 < 8; j3 += 1) {
   for(j4 = 0; j4 < 8; j4 += 4) {
    ...
    cr1[j1][j2][j3] += Lh[j1][j4 + 2] * Mu[j4 + 2][j2][j3];
    cr1[j1][j2][j3] += Lh[j1][j4 + 3] * Mu[j4 + 3][j2][j3];
    }
   }
  }
 }
 ...
 for(k2 = 0; k2 < 8; k2 += 1) {
  for(k3 = 0; k3 < 8; k3 += 1) {
   for(k4 = 0; k4 < 8; k4 += 4) {
    ...
    cr2[k1][k2][k3] += Lh[k1][k4 + 2] * Mu[k2][k4 + 2][k3];
    cr2[k1][k2][k3] += Lh[k1][k4 + 3] * Mu[k2][k4 + 3][k3];
    }
   }
  }
 }
 ...
 for(l2 = 0; l2 < 8; l2 += 1) {
  for(l3 = 0; l3 < 8; l3 += 1) {
   for(l4 = 0; l4 < 8; l4 += 4) {
    ...
    cr3[l1][l2][l3] += Lh[l1][l4 + 2] * Mu[l2][l3][l4 + 2];
    cr3[l1][l2][l3] += Lh[l1][l4 + 3] * Mu[l2][l3][l4 + 3];
    }
   }
  }
 }
