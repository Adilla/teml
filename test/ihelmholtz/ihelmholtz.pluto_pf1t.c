    ...
    for (t2=lbp;t2<=ubp;t2++) {
      for (t3=32*t1-32*t2;t3<=min(N-1,32*t1-32*t2+31);t3++) {
        for (t4=32*t2;t4<=min(M-1,32*t2+31);t4++) {
          for (t6=0;t6<=N-1;t6++) {
            for (t11=0;t11<=N-1;t11++) {
              for (t12=0;t12<=N-1;t12++) {
                tmp1[t3][t11][t6] += A[t12][t3] * u[t4][t12][t11][t6];;
              }
            }
            for (t11=0;t11<=N-1;t11++) {
              for (t12=0;t12<=N-1;t12++) {
                tmp2[t11][t3][t6] += A[t12][t11] * tmp1[t3][t12][t6];;
              }
            }
            for (t11=0;t11<=N-1;t11++) {
              lbv=0;
...
#pragma vector always
              for (t12=lbv;t12<=ubv;t12++) {
                tmp3[t11][t12][t3] += A[t6][t11] * tmp2[t12][t3][t6];;
              }
            }
          }
          for (t6=0;t6<=N-1;t6++) {
...
#pragma vector always
            for (t11=lbv;t11<=ubv;t11++) {
              tmp4[t6][t11][t3] = D[t6][t11][t3] * tmp3[t6][t11][t3];;
            }
          }
          for (t6=0;t6<=N-1;t6++) {
            for (t11=0;t11<=N-1;t11++) {
              for (t12=0;t12<=N-1;t12++) {
                tmp5[t6][t11][t3] += A[t6][t12] * tmp4[t12][t11][t3];;
              }
            }
            for (t11=0;t11<=N-1;t11++) {
              for (t12=0;t12<=N-1;t12++) {
                tmp6[t11][t6][t3] += A[t11][t12] * tmp5[t6][t12][t3];;
              }
            }
            for (t11=0;t11<=N-1;t11++) {
              lbv=0;
...
#pragma vector always
              for (t12=lbv;t12<=ubv;t12++) {
                v[t4][t11][t12][t6] += A[t11][t3] * tmp6[t12][t6][t3];;
              }
            }
          }
        }
