          ...
          for (t6=0;t6<=N-1;t6++) {
            for (t10=0;t10<=N-1;t10++) {
              for (t12=0;t12<=N-1;t12++) {
                tmp1[t3][t10][t6] += A[t12][t3] * u[t4][t12][t10][t6];;
              }
            }
            for (t10=0;t10<=N-1;t10++) {
              for (t12=0;t12<=N-1;t12++) {
                tmp2[t10][t3][t6] += A[t12][t10] * tmp1[t3][t12][t6];;
              }
              lbv=0;
              ubv=N-1;
#pragma ivdep
#pragma vector always
              for (t12=lbv;t12<=ubv;t12++) {
                tmp3[t12][t10][t3] += A[t6][t12] * tmp2[t10][t3][t6];;
              }
            }
          }
          for (t6=0;t6<=N-1;t6++) {
...
#pragma vector always
            for (t10=lbv;t10<=ubv;t10++) {
              tmp4[t6][t10][t3] = D[t6][t10][t3] * tmp3[t6][t10][t3];;
            }
          }
          for (t6=0;t6<=N-1;t6++) {
            for (t10=0;t10<=N-1;t10++) {
              for (t12=0;t12<=N-1;t12++) {
                tmp5[t6][t10][t3] += A[t6][t12] * tmp4[t12][t10][t3];;
              }
            }
            for (t10=0;t10<=N-1;t10++) {
              for (t12=0;t12<=N-1;t12++) {
                tmp6[t10][t6][t3] += A[t10][t12] * tmp5[t6][t12][t3];;
              }
            }
            for (t10=0;t10<=N-1;t10++) {
              lbv=0;
...
#pragma vector always
              for (t12=lbv;t12<=ubv;t12++) {
                v[t4][t10][t12][t6] += A[t10][t3] * tmp6[t12][t6][t3];;
              }
            }
          }
        }
