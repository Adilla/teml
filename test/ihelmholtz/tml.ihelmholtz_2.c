...
void ihelmholtz(double A[const restrict 13][13]) {
  ...
  for (i1 = 0; i1 <= 12; i1 += 1) {
    for (i2 = 0; i2 <= 12; i2 += 1) {
      for (i3 = 0; i3 <= 12; i3 += 1) {
        for (i4 = 0; i4 <= 12; i4 += 1) {
          tmp1[i1][i4][i2] += At[i3][i1] * u[i3][i4][i2];
        }
      }
    }
  }
  for (i1 = 0; i1 <= 12; i1 += 1) {
    for (i2 = 0; i2 <= 12; i2 += 1) {
      for (i3 = 0; i3 <= 12; i3 += 1) {
        for (i4 = 0; i4 <= 12; i4 += 1) {
          tmp2[i2][i4][i3] += At[i1][i2] * tmp1[i4][i1][i3];
        }
      }
    }
  }
  for (i1 = 0; i1 <= 12; i1 += 1) {
    for (i2 = 0; i2 <= 12; i2 += 1) {
      for (i3 = 0; i3 <= 12; i3 += 1) {
        for (i4 = 0; i4 <= 12; i4 += 1) {
          tmp3[i3][i2][i4] += At[i1][i3] * tmp2t[i4][i2][i1];
        }
      }
    }
  }
  for (i1 = 0; i1 <= 12; i1 += 1) {
    for (i2 = 0; i2 <= 12; i2 += 1) {
      for (i3 = 0; i3 <= 12; i3 += 1) {
        tmp4[i3][i2][i1] = Dt[i3][i2][i1] * tmp3t[i1][i2][i3];
      }
    }
  }
  for (i1 = 0; i1 <= 12; i1 += 1) {
    for (i2 = 0; i2 <= 12; i2 += 1) {
      for (i3 = 0; i3 <= 12; i3 += 1) {
        for (i4 = 0; i4 <= 12; i4 += 1) {
          tmp5[i1][i3][i2] += A[i1][i4] * tmp4t[i2][i3][i4];
        }
      }
    }
  }
