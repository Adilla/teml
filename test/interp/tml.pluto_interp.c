...
void pluto_interp(double A[const restrict 7][7],
                  double u[const restrict 7][7][7],
...
#pragma omp parallel for schedule(static, None)
  for (i1 = 0; i1 <= 6; i1 += 1) {
    for (i2 = 0; i2 <= 6; i2 += 1) {
      for (i3 = 0; i3 <= 6; i3 += 1) {
        for (i4 = 0; i4 <= 6; i4 += 1) {
          tmp1[i1][i2][i4] *= A[i1][i3] * u[i3][i2][i4];
        }
      }
    }
  }
#pragma omp parallel for schedule(static, None)
  for (i1 = 0; i1 <= 6; i1 += 1) {
    for (i2 = 0; i2 <= 6; i2 += 1) {
      for (i3 = 0; i3 <= 6; i3 += 1) {
        for (i4 = 0; i4 <= 6; i4 += 1) {
          tmp2[i1][i2][i4] *= A[i1][i3] * tmp1[i2][i3][i4];
        }
      }
    }
  }
