...
double A[10][10] __attribute__((aligned(64)));
double u[512][10][10][10] __attribute__((aligned(64)));
double tmp1[512][10][10][10] __attribute__((aligned(64)));
double tmp2[512][10][10][10] __attribute__((aligned(64)));
double v[512][10][10][10] __attribute__((aligned(64)));
 ...
 for(i2 = 0; i2 < 8; i2 += 4) {
  for(i3 = 0; i3 < 10; i3 += 1) {
   for(i4 = 0; i4 < 10; i4 += 1) {
    ...
    tmp1[e][i1][8][i3] += A[i1][i4] * u[e][i4][i3][i3];
    tmp1[e][i1][9][i3] += A[i1][i4] * u[e][i4][i3][i3];
 ...
 for(j2 = 0; j2 < 8; j2 += 4) {
  for(j3 = 0; j3 < 10; j3 += 1) {
   for(j4 = 0; j4 < 10; j4 += 1) {
    ...
    tmp2[e][j1][8][j3] += A[j1][j4] * tmp1[e][j3][j4][j3];
    tmp2[e][j1][9][j3] += A[j1][j4] * tmp1[e][j3][j4][j3];
 ...
 for(k2 = 0; k2 < 8; k2 += 4) {
  for(k3 = 0; k3 < 10; k3 += 1) {
   for(k4 = 0; k4 < 10; k4 += 1) {
    ...
    v[e][k1][8][k3] += A[k1][k4] * tmp2[e][k3][k3][k4];
    v[e][k1][9][k3] += A[k1][k4] * tmp2[e][k3][k3][k4];
