...
#pragma simd
 for(i2 = 0; i2 < 14; i2 += 1) {
  for(i4 = 0; i4 < 14; i4 += 1) {
   ...
   tmp1[e][i1][i2][11] += A[i1][i4] * u[e][i4][i2][11];
   tmp1[e][i1][i2][12] += A[i1][i4] * u[e][i4][i2][12];
   tmp1[e][i1][i2][13] += A[i1][i4] * u[e][i4][i2][13];
   }
  }
 }
for(j1 = 0; j1 < 14; j1 += 1) {
...
#pragma simd
 for(j2 = 0; j2 < 14; j2 += 1) {
  for(j4 = 0; j4 < 14; j4 += 1) {
   ...
   tmp2[e][j1][j2][11] += A[j1][j4] * tmp1[e][j2][j4][11];
   tmp2[e][j1][j2][12] += A[j1][j4] * tmp1[e][j2][j4][12];
   tmp2[e][j1][j2][13] += A[j1][j4] * tmp1[e][j2][j4][13];
   }
  }
 }
for(k1 = 0; k1 < 14; k1 += 1) {
...
#pragma simd
 for(k2 = 0; k2 < 14; k2 += 1) {
  for(k4 = 0; k4 < 14; k4 += 1) {
   ...
   v[e][k1][k2][11] += A[k1][k4] * tmp2[e][k2][11][k4];
   v[e][k1][k2][12] += A[k1][k4] * tmp2[e][k2][12][k4];
   v[e][k1][k2][13] += A[k1][k4] * tmp2[e][k2][13][k4];
   }
  }
 }
}
