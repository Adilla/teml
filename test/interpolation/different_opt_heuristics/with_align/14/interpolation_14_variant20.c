...
#pragma simd
  for(i3 = 0; i3 < 12; i3 += 4) {
   for(i4 = 0; i4 < 14; i4 += 1) {
    ...
    tmp1[e][i1][i2][12] += A[i1][i4] * u[e][i4][i2][i4];
    tmp1[e][i1][i2][13] += A[i1][i4] * u[e][i4][i2][i4];
...
#pragma simd
  for(j3 = 0; j3 < 12; j3 += 4) {
   for(j4 = 0; j4 < 14; j4 += 1) {
    ...
    tmp2[e][j1][j2][12] += A[j1][j4] * tmp1[e][j2][j4][j4];
    tmp2[e][j1][j2][13] += A[j1][j4] * tmp1[e][j2][j4][j4];
...
#pragma simd
  for(k3 = 0; k3 < 12; k3 += 4) {
   for(k4 = 0; k4 < 14; k4 += 1) {
    ...
    v[e][k1][k2][12] += A[k1][k4] * tmp2[e][k2][k4][k4];
    v[e][k1][k2][13] += A[k1][k4] * tmp2[e][k2][k4][k4];
