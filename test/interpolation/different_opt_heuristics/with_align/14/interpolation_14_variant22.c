 ...
 for(i2 = 0; i2 < 12; i2 += 4) {
  for(i3 = 0; i3 < 14; i3 += 1) {
   for(i4 = 0; i4 < 14; i4 += 1) {
    ...
    tmp1[e][i1][12][i3] += A[i1][i4] * u[e][i4][i3][i3];
    tmp1[e][i1][13][i3] += A[i1][i4] * u[e][i4][i3][i3];
 ...
 for(j2 = 0; j2 < 12; j2 += 4) {
  for(j3 = 0; j3 < 14; j3 += 1) {
   for(j4 = 0; j4 < 14; j4 += 1) {
    ...
    tmp2[e][j1][12][j3] += A[j1][j4] * tmp1[e][j3][j4][j3];
    tmp2[e][j1][13][j3] += A[j1][j4] * tmp1[e][j3][j4][j3];
 ...
 for(k2 = 0; k2 < 12; k2 += 4) {
  for(k3 = 0; k3 < 14; k3 += 1) {
   for(k4 = 0; k4 < 14; k4 += 1) {
    ...
    v[e][k1][12][k3] += A[k1][k4] * tmp2[e][k3][k3][k4];
    v[e][k1][13][k3] += A[k1][k4] * tmp2[e][k3][k3][k4];
